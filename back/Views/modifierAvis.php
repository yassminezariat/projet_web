...
$avisC = new avisC();
$liste=$avisC->recupereravis($_GET['id']);
...
if (isset($_POST["description"])&& isset($_POST["note"])&& isset($_POST["type_avis"]))
{
  ...
  $avis = new Avis($_POST['description'],(int)$_POST['note'],(int)$_SESSION['id'],(string)$_POST["type_avis"]);
    ...
    header("location:gestion_reclamation.php");
              ...
              <section id="ajout">
                <div class="grid-form">
                    <div class="grid-form1">
                        <h2 id="forms-example" class="">Ajouter avis</h2>
                        <?php
                        ...
                        <form action="" method="POST" class="form">
                          <div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Note sur 5</label>
                                <select name="note">

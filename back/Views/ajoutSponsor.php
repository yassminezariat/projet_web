        ...
        <div class="mother-grid-inner">
            ...
            <div class="header-main">
                ...
                <div class="grid-form1">
                    <h3>Ajouter un sponsor</h3>
                    <div class="tab-content">
                            <form class="form-horizontal" method="post">
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Nom</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1"  name="nom" placeholder="Nom" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="disabledinput" class="col-sm-2 control-label">Prenom</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1"  name="prenom" placeholder="Prenom" required>
                                    </div>
                                </div>
                                <div class="form-group">

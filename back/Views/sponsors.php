        ...
        <div class="mother-grid-inner">
            ...
            <div class="grid-form1">
                ...
                <form method="post" action="sponsors.php">
                    ...
                    <table class="table">
                        ...
                        foreach ($liste as $item) {
                            ...
                            <tr>
                                ...
                                <td><a href="modifierSponsor.php?id=<?php echo $item['id'] ?>">Modifier</a></td>
                                <?php
                                if($sponsorc->existSponsor($item['id'])==0) {
                                    ?>
                                    <td><a href="supprimerSponsor.php?id=<?php echo $item['id'] ?>">Supprimer</a></td>
                                    <?php
                                }
                                ?>
                            </tr>
                    ...
                    <a href="ajoutSponsor.php">Ajouter un Sponsor</a>
                </div>
            </div>
        </div>
        <!--//grid-->

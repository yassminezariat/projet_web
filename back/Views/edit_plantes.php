                          ...
                          <h2 id="forms-example" class="">Modifier plante</h2>
                            <?php foreach($result as $rows) {?>
                                ...
                                <div id="div_environnement" class="form-group">
                                    ...
                                    <input type="text" class="form-control1" name="environnement" id="environnement" value="<?php echo $rows['environnement'] ?>" >
                                ...
                                <div id="div_image" class="form-group">
                                    ...
                                    <div  role="alert" id="err_image" value="<?php echo $rows['image'] ?>" ></div>
                                </div>

...
<?php
include_once "..\Model\plantes.php";
...
if (isset($_POST["espece"]) && isset($_POST["environnement"])&& isset($_POST["prix"])&& isset($_POST["origine"])&& isset($_POST["image"]))
                      ...
                      <div class="grid-form1">
                          ...
                          <form action="" method="POST" onSubmit="return controlersaisie();">
                            ...
                            <div id="div_environnement" class="form-group">
                                ...
                                <input type="text" class="form-control1" name="environnement" id="environnement" placeholder="environnement" >

...
if(isset($_GET['id'])) {
    ...
    $sponsor=$sponsorc->recupererSponsor($_GET['id']);
    if (isset($_POST['nom']) and isset($_POST['prenom']) and isset($_POST['email']) and isset($_POST['type'])) {
        $s = new Sponsor($_POST['nom'], $_POST['prenom'], $_POST['email'], $_POST['type']);
        $s->setId($_GET['id']);
        $sponsorc->modifierSponsor($s);
                        ...
                        <form class="form-horizontal" method="post">
                            ...
                            foreach ($sponsor as $item) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" value="<?php echo $item['nom'] ?>" name="nom"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" value="<?php echo $item['prenom'] ?>" name="prenom" placeholder="Prenom" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="disabledinput" class="col-sm-2 control-label">Email</label>
                                    <div class="col-sm-8">
                                        <input type="email" value="<?php echo $item['email'] ?>" class="form-control1" name="email" placeholder="Email" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="checkbox" class="col-sm-2 control-label">Type</label>
                                    <div class="col-sm-8">
                                        <select name="type" class="form-control" required>
                                            <option><?php echo $item['type'] ?></option>
                                            <option>Sponsoring financier</option>
                                            <option>Sponsoring technologique</option>
                                            <option>Sponsoring en nature</option>
                                        </select>
                                    </div>
        ...
        <div class="menu">
            <ul id="menu">
                ...
                <li id="menu-academico"><a href="#"><i class="fa fa-list-ul"
                                                       aria-hidden="true"></i><span> Short Codes</span> <span

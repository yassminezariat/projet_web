                ...
                <section id="ajout">
                   <div class="grid-form">
                       <div class="grid-form1">
                         <center>
                           <h2 id="forms-example" class="">veuillez consulter la liste des reclamations</h2>
                         </center>
                         <br></br>
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu">
                <ul id="menu">
                    ...
                    <li id="menu-academico"><a href="gestion_avis.php"><i class="fa fa-envelope nav_icon"></i><span>Gestion des avis</span>
                            <div class="clearfix"></div>
                        </a>

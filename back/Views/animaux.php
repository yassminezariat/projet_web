...
if (isset($_POST["race"])&& isset($_POST["espece"]) && isset($_POST["date_naissance"])&& isset($_POST["prix"])&& isset($_POST["origine"])&& isset($_POST["image"]))
    ...
    $animal = new animal(
        $_POST['race'],
        $_POST['espece'],
        $newDate = date("Y-m-d", strtotime($_POST['date_naissance'])),
        (int)$_POST['prix'],
        $_POST['origine'],
        (string)$_POST['image']
                    ...
                    <div class="grid-form1">
                        ...
                        <form action="" method="POST" onSubmit="return controledesaisie()">
                            <div id="div_race" class="form-group">
                                ...
                                <input type="text" class="form-control1"  name="race" id="race" placeholder="Race naimal">
                                <div  role="alert" id="err_race" ></div>

                            </div>
                            <div id="div_espece" class="form-group">
                                <label for="exampleInputPassword1">Espece</label>
                                <input type="text" class="form-control1" name="espece" id="espece" placeholder="Espece">
                                <div  role="alert" id="err_espece" ></div>
                            </div>
                            <div id="div_date_naissance" class="form-group">
                                <label for="exampleInputPassword1">Date de naissance</label>
                                <input type="date" class="form-control1" name="date_naissance" id="date_naissance" name="trip-start">
                            ...
                            <div id="div_origine" class="form-group">
                                ...
                                <input type="text" class="form-control1" name="origine" id="origine" placeholder="Origine">

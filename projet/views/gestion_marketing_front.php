...
if (isset($_POST["id_eve"])&& isset($_POST["date_eve"])&& isset($_POST["type_eve"]))
    ...
    $evenement = new evenement((int)$_POST['id_eve'],(string)$_POST['date_eve'],(string)$_POST["type_eve"]);
...
<div class="col-lg-7">
                      <h5 class="cont-form" data-blast="color">table des evenement</h5>
                    ...
                    <div class="grid-form1">
                        ...
                        <center>
                                  <table border="10" cellpading="20" width = "200%" >
                                      <tr >
                                    <td>

                                        <table border="10" cellpading="20" width = "200%" >
                                        <tr>
                                          <th style="background-color: rgb(211, 184, 0) ; color: rgb(250, 250, 250);" >identifiant</th>
                                          <th style="background-color: rgb(211, 184, 0) ; color: rgb(250, 250, 250);" >date</th>
                                          <th style="background-color: rgb(211, 184, 0) ; color: rgb(250, 250, 250);" >type </th>
        ...
        $query= $pdo ->prepare( 'SELECT * FROM even');
   ...
   $result = $query->fetchAll();
    ...
    echo("</table>");
            ...
            <div class="col-lg-7">
                      <h5 class="cont-form" data-blast="color">table des sponsors</h5>
                      <div class="contact-form-wthreelayouts">
                          <form action="#" method="post" class="register-wthree" >
                          <section  id="affichage">
                    <div class="grid-form1">
                        <h2 id="forms-example" class="">La liste des sponsors</h2>
                        <center>
                                  <table border="10" cellpading="10" width = "200%" >
                                      <tr >
                                    <td>
                                        ...
                                        <tr>
                                          <th style="background-color: rgb(211, 184, 0) ; color: rgb(250, 250, 250);" >identifiant</th>
                                          <th style="background-color: rgb(211, 184, 0) ; color: rgb(250, 250, 250);" >date</th>
                                          <th style="background-color: rgb(211, 184, 0) ; color: rgb(250, 250, 250);" >email</th>
                                          <th style="background-color: rgb(211, 184, 0) ; color: rgb(250, 250, 250);" >nom </th>
                                          <th style="background-color: rgb(211, 184, 0) ; color: rgb(250, 250, 250);" >prenom </th>
                                          <th style="background-color: rgb(211, 184, 0) ; color: rgb(250, 250, 250);" >type </th>
    ...
    foreach($result as $rows)
    {
        ...
        .$rows['email_spons']. $rows['nom_spons']. "</td><td>" .$rows['prenom_spons']. "</td><td>" .$rows['type_spons']. "</td><td>" ."</td><td>";

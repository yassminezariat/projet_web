                    ...
                    <div class="contact-form-wthreelayouts">
                        <form  method="post" class="register-wthree">
                            ...
                            <div class="form-group">
                                ...
                                <textarea onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();" id="msg" name="description" placeholder="100 caractere au maximum" class="form-control" required></textarea>
                                <div id="indic"></div>
                            </div>
                            <div class="form-group mb-0">
                                <button type="submit" class="btn btn-w3layouts btn-block  bg-theme text-white w-100 font-weight-bold text-uppercase" data-blast="bgColor">Ajouter</button>
                            </div>

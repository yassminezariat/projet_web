...
if(isset($_GET['id'])) {
    ...
    $eventc = new EventC();
    if($eventc->existeAffectation($_GET['id'])==1){
        $liste = $eventc->recupererEventAffectation($_GET['id']);
    }
    else{
        $liste = $eventc->recupererEvent($_GET['id']);
    }
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light fixed-top navbar-expand-lg navbar-light navbar-fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <button type="button" class="btn  wthree-link-bnr bg-theme rounded-circle text-center mt-lg-0 mt-3"
                            data-toggle="modal" aria-pressed="false" data-target="#exampleModal"
                            data-blast="bgColor"> <span
                ...
                <div class="col-lg-12">
                    <div class="contact-form-wthreelayouts">
                            ...
                            foreach ($liste as $item) {
                                ?>
                                <div><strong>Type d'evenement :</strong><?php echo $item['type'] ?></div>
                                <div><strong>Description d'evenement :</strong><?php echo $item['description'] ?></div>
                                <div><strong>Date d'evenement :</strong><?php echo $item['date'] ?></div>
                                <?php
                                if(isset($item['nom'])) {
                                    ?>
                                    <div><strong>Nom de sponsor :</strong><?php echo $item['nom'] . " " . $item['prenom'] ?></div>
                                    <div><strong>Email de sponsor :</strong><?php echo $item['email'] ?></div>
                                    <?php
                                }
                                else{
                                    ?>
                                    <div><strong>Etat d'evenement :</strong>Non Approuvé </div>
                                   <?php
                                }
                            }
                            ?>

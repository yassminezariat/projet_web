...
if(isset($_GET['id'])){
    ...
    $user_id=0;//session $_SESSION['id']
    if(isset($_POST['type']) and isset($_POST['description']) and isset($_POST['date'])){
        $e=new Event($_POST['date'],$_POST['type'],$_POST['description'],0,$user_id);
        $e->setId($_GET['id']);
        $eventc->modifierEvent($e);
                        ...
                        <form  method="post" class="register-wthree">
                            ...
                            foreach ($event as $item) {
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" style="height: 60px" name="type" required>
                                        <option><?php echo $item['type'] ?></option>
                                        <option value="Team building">Team building</option>
                                        <option value="Séminaire">Séminaire</option>
                                        <option value="Congres">Congres</option>
                                        <option value="Journée d etude">Journée d etude</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>
                                    ...
                                    <input class="form-control" value="<?php echo $item['date'] ?>" type="date" name="date" required>
                                </div>
                                <div class="form-group">
                                    <label>
                                        Description
                                    </label>
                                    <textarea onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();" id="msg" name="description" placeholder="100 caractere au maximum" class="form-control" required><?php echo $item['description'] ?></textarea>
                                    <div id="indic"></div>
                                </div>
                                <div class="form-group mb-0">
                                    <button type="submit"
                                            class="btn btn-w3layouts btn-block  bg-theme text-white w-100 font-weight-bold text-uppercase"
                                            data-blast="bgColor">Modifier
                                    </button>
                                </div>
                                <?php
                            }

...
if(isset($_GET['id'])) {
    ...
    if(isset($_POST['sponsor_id'])){
        $eventC->affecterSponsor($_POST['sponsor_id'],$_GET['id']);
        $eventC->approuverEvent($_GET['id']);
                        ...
                        <form class="form-horizontal" method="post">
                            ...
                            foreach ($event as $row) {
                                ...
                                <div class="form-group">
                                    <label for="checkbox" class="col-sm-2 control-label">Type:<?php echo $row['type'] ?></label>
                                </div>
                                <div class="form-group">
                                    <label for="checkbox" class="col-sm-2 control-label">Description:<?php echo $row['description'] ?></label>
                                </div>
                                <div class="form-group">
                                    <label for="checkbox" class="col-sm-2 control-label">Date:<?php echo $row['date'] ?></label>
                                </div>
                                <?php
                            }
                            ?>
                            <div class="form-group">
                                <label for="checkbox" class="col-sm-2 control-label">Sponsor</label>
                                <div class="col-sm-8">
                                    <select name="sponsor_id" class="form-control">
                                        ...
                                        foreach ($sponsors as $item) {
                                            ?>
                                            <option
                                                value="<?php echo $item['id'] ?>"><?php echo $item['nom'] . " " . $item['prenom'] ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-info" value="Approuver">
                            </div>
                        </form>
                    </div>
                </div>

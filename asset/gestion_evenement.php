...
function verifier()
{ if (document.fiche.id_eve.value=="")
{ alert('Saisissez le id ! ');
}
else
{ if (document.fiche.date_eve.value=="")
{ alert('Saisissez le date ! ');
}
else
{ if (document.fiche.type_eve.value=="")
{ alert('Saisissez ltype ! ');
}
};};};
</script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          ['congrés',      2],
          ['seminaire',  2],
          ['salon de profession', 2],
          ['team building',    7]
        ]);

        var options = {
          title: 'Mes statistiques selon les types des évévnements '
        };
                ...
                <section id="ajout">
                    <div class="grid-form">
                        <div class="grid-form1">
                            <h2 id="forms-example" class="" style="color:red;" >Ajouter un evenement :</h2>
                            <form action="" method="POST" name="fiche">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">IDENTIFIANT</label>
                                    <input type="text" class="form-control"  name="id_eve" id="id_eve" placeholder="identifiant d'evenement">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">DATE DE L'EVENEMENT</label>
                                <input type="date" class="form-control" name="date_eve" id="date_eve" name="trip-start">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">TYPE D'EVENEMENT</label>
                            <select name="type_eve">
                            <option value=""></option>
<option value="conference">conference</option>
<option value="congres">congrés</option>
<option value="semonaire">seminaire</option>
<option value="salon de profession">salon de profession</option>
<option value="team building">team building</option>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        ...
                                        <a class="btn-primary btn" href="cherchereve.php" class="button"> chercher</a>
                ...
                <section  id="affichage">
                    ...
                    <div class="grid-form1">
                        ...
                        <h2 id="forms-example" class="">La liste des evenement</h2>
                    <table>
                        <tr>
                            <th>Identifiant</th>

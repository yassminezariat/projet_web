...
$evenementc = new evenementC();
    ...
    $query= $pdo ->prepare("select * from even where id_eve= '$id'");
...
if (isset($_POST["id_eve"])&& isset($_POST["date_eve"]) && isset($_POST["type_eve"]))
    {//{if (empty($_POST["nom"])&& empty($_POST["prenom"]) && empty($_POST["dateNais"]) && empty($_POST["email"]) && empty($_POST["tel"]) && empty($_POST["adresse"]) && empty($_POST["login"]) && empty($_POST["pass"])) {
        ...
        $id_eve=$_POST['id_eve'];
      $date_eve=$newDate = date("Y-m-d", strtotime($_POST['date_eve']));
      $type_eve= (string)$_POST['type_eve'];

    $evenement= new evenement($id_eve,$date_eve,$type_eve);
    $evenementc->cherchereve($id_eve);
                        ...
                        <div class="grid-form1">
                            ...
                            <form action="" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="id_eve" id="id_eve" placeholder="identifiant d'evenement" value="<?php echo $rows['id_eve'] ?>">
                                    

                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">DATE DE L'EVENEMENT</label>
                                <input type="date" class="form-control" name="date_eve" id="date_eve" name="trip-start" value="<?php echo  $rows['date_eve']?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">TYPE D'EVENEMENT</label>
                            <select name="type_eve"  value="<?php echo $rows['type_eve']?>">
...
<option value="team building">team building</option>
                ...
                <section  id="affichage">
                    <div class="grid-form1">
                        ...
                        <form methode="get" >
                        <input type="search" name="id_eve" placeholder="rechercher..." onclick="cherchereve($id_eve)"/>
                        <input type="submit" value="valider" onclick="cherchereve($id_eve)"/>
                    </form>
                    <table>
                        <tr>
                            <th>Identifiant</th>

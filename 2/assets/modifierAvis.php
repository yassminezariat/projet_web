        ...
        <div class="container pt-lg-5">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-7">
                    ...
                    <di8v class="contact-form-wthreelayouts">
                      <?php
                        ...
                        <form action="#" method="post" class="register-wthree" onSubmit="return Verification()">
                          <div>
                            <select name="type_avis">
                              <option value="<?php echo $row['type_avis']; ?>"><?php echo $row['type_avis']; ?></option>
                            ...
                            <div class="form-group">
                              <h3 for="exampleInputPassword1">Donnez une note </3>
                              <select name="note">
                            ...
                            <div class="form-group mb-0">
                                <button type="submit" class="btn btn-w3layouts btn-block  bg-theme text-white w-100 font-weight-bold text-uppercase" data-blast="bgColor" >update</button>
                            </div>
                            <?php
                              }
                             ?>

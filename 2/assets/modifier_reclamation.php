...
if (isset($_POST["type_reclamation"])&& isset($_POST["description_reclamation"]))
    ...
    $reclamationC->updatereclamation($reclamations,$_GET['id']);
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <div class="abt_bottom py-lg-5 bg-theme" data-blast="bgColor">
        <div class="container py-sm-4 py-3">
            <h4 class="abt-text text-capitalize text-sm-center mb-0">COMMENT POUVONS-NOUS VOUS AIDER ?</h4>
                                      ...
                                      <tr>
                                        ...
                                        <th style="background-color: rgb(211, 184, 0) ; color: rgb(250, 250, 250);" >le type de l'avis</th>
                                          ...
                                          foreach ($liste as $row){
                                            ...
                                            <td>
                                              <tr>
                                                <td><br></br><?php echo $row['description'];  ?><br></br> </td>
                                                ...
                                                <td><a href="modifierAvis.php?id=<?php echo $row['id_avis'];  ?>">Modifier</a></td>
                                              </tr>
    ...
    <!-- //footer -->
    <!-- login  -->
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"  width="80" height="80">
        <div class="modal-dialog modal-dialog-centered" role="document" >
            <div class="modal-content" width="90"  width="80" height="80">
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">formulaire reclamation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form action="#" method="post" class="p-sm-3">
                        <div class="form-group">
                            ...
                            <select name="type_reclamation"  class="form-control" placeholder="type_reclamation" id="type_reclamation" required="">
                              <option value="<?php echo $row['type_reclamation']; ?>"><?php echo $row['type_reclamation']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="" name="description_reclamation" id="description_reclamation" required="" value="<?php echo $row['description_reclamation'] ?>">
                        </div>
                        <div class="form-group">
                        </div>
                        <div class="form-group">
